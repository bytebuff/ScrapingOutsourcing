...
/*****************************************新增方法***********************************************************/
function checkCal(dates){
	if(dates.length!=10||dates.substring(4,5)!='-'||dates.substring(7,8)!='-')
		return false;
	else
		return true;
}
function attachUnloadEvent(){
	var toclose = function(){
		baseCtrl.doBaseService(960403,null,function(){});
	};
	document.body.attachEvent('onclose',toclose);
}
